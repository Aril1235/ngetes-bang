// SC BY X-DEV TEAM - KIZAKIXD - VALL PAPOYE - ARIL NM
...
offline = false
targetpc = '0'
ownerNumber = ["6283172490882@s.whatsapp.net","62895333288886@s.whatsapp.net", ]
fake = 'arilbotz'
fake1 = '_*© 𝙲𝚁𝙴𝙰𝚃𝙴𝙳 𝙱𝚈 𝙰𝚁𝙸𝙻 𝙽𝙼*_'
numbernye = '0'
waktu = '_'
alasan = '-'
...
qur = budy.slice(2)
exec(qur, (err, stdout) => {
if (err) return reply(`@𝙰𝚁𝙸𝙻 𝙽𝙼:~ ${err}`)
if (stdout) {
reply(stdout)
}
})
